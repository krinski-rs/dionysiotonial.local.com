...
class DionysioTonial extends React.Component
{
	render() {
		                ...
		                <GridItem xs={12} sm={12} md={6}>
		                  <div className={classes.profile}>
		                    ...
		                    <div className={classes.name}>
		                      <h3 className={classes.title}>Dionysio Tonial</h3>
		                      <h6>Imão Dionysio Tonial</h6>
...
DionysioTonial.propTypes = {
	classes: PropTypes.object
};
export default withStyles(style)(DionysioTonial);
